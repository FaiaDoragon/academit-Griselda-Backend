...
export class ArticlesController {
  ...
  @ApiOperation({
    ...
    description:
      'Crea un nuevo artículo con los datos proporcionados y opcionalmente una imagen.',
  })
  @ApiCreatedResponse({
    description: 'El artículo se ha creado exitosamente.',
    type: ArticleResponseDto,
  }) // Usa el DTO de respuesta en la anotación de Swagger
  @ApiBadRequestResponse({
    description:
  ...
  @ApiOkResponse({
    description: 'El artículo se ha recuperado exitosamente.',
    type: ArticleResponseDto,
  }) // Usa el DTO de respuesta en la anotación de Swagger
  ...
  @ApiOperation({
    ...
    description:
      'Actualiza los datos de un artículo existente y opcionalmente su imagen.',
  })
  @ApiOkResponse({
    description: 'El artículo se ha actualizado exitosamente.',
    type: ArticleResponseDto,
  }) // Usa el DTO de respuesta en la anotación de Swagger
  @ApiNotFoundResponse({ description: 'Artículo no encontrado.' })
  @ApiBadRequestResponse({
